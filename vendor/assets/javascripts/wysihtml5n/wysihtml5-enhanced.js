(function($){
  ...
  var WysiHTML5N = function(textarea, options){
    ...
    var toolbar = {
      ...
      superscript:  '<li data-wysihtml5-command="superscript" title="Insert superscript or exponent" class="command btn">x<sup>2</sup></li>',
      subscript:    '<li data-wysihtml5-command="subscript" title="Insert subscript" class="command btn">x<sub>2</sub></li>',
